...
import { type UploadedQuestions } from '../components/UploadQuestions/UploadQuestions';
...
export interface vezerloContextType {
  ...
  setUploadedQuestions: React.Dispatch<
    React.SetStateAction<UploadedQuestions | null>
  >;
}
